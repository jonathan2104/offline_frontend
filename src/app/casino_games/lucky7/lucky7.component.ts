...
export class Lucky7Component implements OnInit, OnDestroy {
    ...
    getResultHistory() {
        this.resultSubscription = this.lucky7Service.getResultHistory().subscribe((res: any) => {
            if (res != null) {
    ...
    getLiveData() {
        this.dataSubscription = this.lucky7Service.getLiveData().subscribe((res: any) => {
            if (res != null) {
                if (res.success) {
    ...
    getCasinoBetsByMarketId() {
        ...
        if (this.last_market_id != '') {
            this.betHistorySubscription = this.casinoBetsService.getCasinoBetsByMarketId(this.last_market_id, 'lucky7').subscribe((res: any) => {
    ...
    getCasinoExposureByMarketId() {
        ...
        if (this.last_market_id != '') {
            this.casinoExposureSubscription = this.casinoBetsService.getCasinoExposureByMarketId(this.last_market_id, 'lucky7').subscribe((res: any) => {
